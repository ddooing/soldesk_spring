...
public class MainBannerBean {
	...
	public int getMain_banner_id() {
		return main_banner_id;
	}

	public void setMain_banner_id(int main_banner_id) {
	...
	public String getMain_banner_name() {
		return main_banner_name;
	}

	public void setMain_banner_name(String main_banner_name) {
		this.main_banner_name = main_banner_name;
	}
	...
	public MultipartFile getMain_banner_file() {
		return main_banner_file;
	}

	public void setMain_banner_file(MultipartFile main_banner_file) {
		this.main_banner_file = main_banner_file;
	}
