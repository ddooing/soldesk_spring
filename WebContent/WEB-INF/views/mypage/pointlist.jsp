		...
		<c:choose>
				...
				<div style="display: flex;">
					...
					<div class="test-center" style="margin:auto; margin-top:100px; display:flex; flex-direction:column; align-items:center;">
					    ...
					    <h3 style="margin-top:50px;">포인트 내역이 없습니다</h3>
					</div>
			...
			<div class="d-none d-md-block" style="margin-top:50px;">
				<ul class="pagination justify-content-center">
					<c:choose>
						...
						<c:otherwise>
							<li class="page-item">
								<a href="${root }/mypage/pointlist?user_id=${loginUserBean.user_id}&page=${pageBean.prevPage}" class="page-link">이전</a>
							</li>
						</c:otherwise>
					</c:choose>
						...
						<c:choose>
							<c:when test="${idx == pageBean.currentPage }">
								<li class="page-item active" >
									<a href="${root }/mypage/pointlist?user_id=${loginUserBean.user_id}&page=${idx}" class="page-link">
										${idx }
									</a>
								</li>
							</c:when>
					...
					<c:choose>
						...
						<c:otherwise>
							<li class="page-item">
								<a href="${root }/mypage/pointlist?user_id=${loginUserBean.user_id}&page=${pageBean.nextPage}" class="page-link">다음</a>
							</li>
						</c:otherwise>
					</c:choose>
				</ul>
