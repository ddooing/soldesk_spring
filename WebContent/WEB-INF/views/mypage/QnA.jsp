		...
		<div class="menubar" style="/*width:80%;*/ margin:auto; justify-content: center; display: flex;padding-top: 75px;  flex-direction: column;">
 			...
 			<div class="ullist visible" style="padding-top:20px;">
			   <ul id="mypageMenu" class="submenu">
			    ...
			    <ul id="crmMenu" class="submenu visible" >
	                ...
	                <li id="qna" class="sel" onclick="window.location.href='${root}/mypage/QnA?user_id=${loginUserBean.user_id }'">Q&A</li>
			...
			<div class="qna" style="margin:auto;">
					...
					<section class="notice" style="width:860px; display: flex; margin-top:50px; ">
						<div id="board-list">
							<div style="width: 835px; border-top: 1px solid #ccc; border-bottom: 1px solid #ccc;">
								...
								<!--내용-->
								<div id="review_1" style="display: flex; justify-content: center;  align-items: center; text-align: center; border-top: 1px solid #e7e7e7">
								...
								<div style="display: none; width: 835px; justify-content: center; margin-top: 20px; margin-bottom: 20px; padding-left: 110px; padding-right: 50px;" id="review_1_click">
									<div>이거 어떻게 해야해요?</div>
									<br>
									<div>
								...
								<div id="review_2" style="display: flex; justify-content: center;  align-items: center; text-align: center; border-top: 1px solid #e7e7e7">
									<div style="width: 100px; padding: 14px 0px;">
										<p1>2</p1>
									</div>
									<div style="width: 700px; text-align: left; padding: 14px 14px 14px 28px;">
								...
								<div style="display: none; width: 835px; justify-content: center; margin-top: 20px; margin-bottom: 20px; padding-left: 110px; padding-right: 50px;" id="review_2_click">
									<div>이거 어떻게 해야해요?</div>
									<br>
									<div>
										<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-return-right" viewBox="0 0 16 16">
								...
								<div id="review_3" style="display: flex; justify-content: center;  align-items: center; text-align: center; border-top: 1px solid #e7e7e7">
									<div style="width: 100px; padding: 14px 0px;">
										<p1>3</p1>
									</div>
								...
								<div style="display: none; width: 835px; justify-content: center; margin-top: 20px; margin-bottom: 20px; padding-left: 110px; padding-right: 50px;" id="review_3_click">
									<div>이거 어떻게 해야해요?</div>
									<br>
									<div>
										<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-return-right" viewBox="0 0 16 16">
								...
								<div id="review_4" style="display: flex; justify-content: center;  align-items: center; text-align: center; border-top: 1px solid #e7e7e7">
									<div style="width: 100px; padding: 14px 0px;">
										<p1>4</p1>
									</div>
									<div style="width: 700px; text-align: left; padding: 14px 14px 14px 28px;">
								...
								<div style="display: none; width: 835px; justify-content: center; margin-top: 20px; margin-bottom: 20px; padding-left: 110px; padding-right: 50px;" id="review_4_click">
									<div>이거 어떻게 해야해요?</div>
									<br>
									<div>
										<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-return-right" viewBox="0 0 16 16">
								...
								<div id="review_5" style="display: flex; justify-content: center;  align-items: center; text-align: center; border-top: 1px solid #e7e7e7">
									<div style="width: 100px; padding: 14px 0px;">
										<p1>5</p1>
									</div>
									<div style="width: 700px; text-align: left; padding: 14px 14px 14px 28px;">
								...
								<div style="display: none; width: 835px; justify-content: center; margin-top: 20px; margin-bottom: 20px; padding-left: 110px; padding-right: 50px;" id="review_5_click">
									<div>이거 어떻게 해야해요?</div>
									<br>
									<div>
										<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-return-right" viewBox="0 0 16 16">
				...
				<div style="margin-top:20px;">
					<button class="btn btn-dark" data-bs-toggle="modal" data-bs-target="#qnaModal" style="align-self: flex-end; margin-top: 10px; margin-left: 1550px;">문의 작성</button>
				</div>
				...
				<div class="modal-dialog modal-lg">
    				<div class="modal-content" style="width: 950px; border-radius: 25px;">
        				<div class="modal-header">
            				...
            				<button type="button" style="border:none; background-color:transparent;" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
