		...
		<div class="archivegrid"
			...
			<div class="reivewmodal">
				<div class="reivewmodal_body">
					...
					<hr />
					<%-- <form:form action="${root }/review_pro" method="post" modelAttribute="asdf"> --%>
					...
					<div class="review"
						...
						<form:textarea path="a" value="Truly speaking i only see the
						world through YOU. I lack the sense of direction"/>
						 </div>
					<!-- textarea에 대한 팝업 크기 조절 추가하기 -->

					<div class="checkbox-wrapper-17"
						style="margin-top: 10px; display: flex; align-items: center;">
						<form:input type="checkbox" id="switch-17" path="asd"/><label for="switch-17"></label>
						
						<span style="margin-left: 10px;">공개 여부</span>
						<button type="submit" class="btn btn-dark" style="margin-left:270px;" role="button"
							onclick="goReviewEditor()">제출</button>
