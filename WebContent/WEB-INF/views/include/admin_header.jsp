...
<nav class="sb-topnav navbar navbar-expand navbar-custom">
    <!-- 아트미 로고-->
    <a class="navbar-brand ps-3" href="${root }/view/index" style="margin-left: 20px;"><img src="../img/ARTMEE.png"
				...
				<div class="sb-sidenav-menu">
					<div class="nav">
						...
						<a class="nav-link" href="${root }/admin/manager_accountmanager">
						 ...
						 <a class="nav-link collapsed" href="${root }/admin/manager_reservelist">
							<div class="sb-nav-link-icon">
