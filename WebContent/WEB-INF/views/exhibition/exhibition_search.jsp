	...
	<section id="무료">
		<div class="text-center mb-4"
		    ...
		    <div style="margin-top: 50px; display: flex; margin-left:35px; flex-wrap: wrap; justify-content: start;">
		    		<c:forEach items="${getAllExibitionInfo}" var="freeexhibition">
							...
							<div class="d-none d-md-block" style="margin-top: 50px;">
								<ul class="pagination justify-content-center">
									<c:choose>
										...
										<c:otherwise>
											<li class="page-item"><a
												href="${root }/exhibition/exhibition_search?page=${pageBean.prevPage}"
										...
										<c:choose>
											<c:when test="${idx == pageBean.currentPage }">
												<li class="page-item active"><a
													href="${root }/exhibition/exhibition_search?page=${idx}"
									...
									<c:choose>
										...
										<c:otherwise>
											<li class="page-item"><a
												href="${root }/exhibition/exhibition_search?page=${pageBean.nextPage}"
							...
							<div class="d-none d-md-block" style="margin-top: 50px;">
								<ul class="pagination justify-content-center">
									<c:choose>
										...
										<c:otherwise>
											<li class="page-item"><a
												href="${root }/exhibition/exhibition_search?keyword=${keyword}&page=${pageBean2.prevPage}"
												class="page-link">이전</a></li>
										</c:otherwise>
									</c:choose>
									...
									<c:forEach var="idx" begin="${pageBean2.min}"
										...
										<c:choose>
											<c:when test="${idx == pageBean2.currentPage }">
												<li class="page-item active"><a
													href="${root }/exhibition/exhibition_search?keyword=${keyword}&page=${idx}"
													class="page-link"> ${idx } </a></li>
											</c:when>
											<c:otherwise>
												<li class="page-item"><a
									...
									<c:choose>
										...
										<c:otherwise>
											<li class="page-item"><a
												href="${root }/exhibition/exhibition_search?keyword=${keyword}&page=${pageBean2.nextPage}"
												class="page-link">다음</a></li>
										</c:otherwise>
									</c:choose>
								</ul>
