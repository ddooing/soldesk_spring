	...
	<section class="vh-60">
		...
		<div style="margin-top: 30px; text-align: center; margin-right: 850px;">
			...
			<button id="soonendbtn" type="button" onclick="window.location.href='${root}/exhibition/exhibition_soon_end'"
				style="color: black; font-size: 25px; text-decoration: none; border: none; background-color: transparent;  margin-left: 15px;">곧종료</button>
		</div>
	</section>
		...
		<div class="d-none d-md-block" style="margin-top:50px;">
				<ul class="pagination justify-content-center">
					<c:choose>
						...
						<c:otherwise>
							<li class="page-item">
								<a href="${root }/exhibition/exhibition_soon_end?page=${pageBean.prevPage}" class="page-link">이전</a>
							</li>
						</c:otherwise>
					</c:choose>
						...
						<c:choose>
							<c:when test="${idx == pageBean.currentPage }">
								<li class="page-item active" >
									<a href="${root }/exhibition/exhibition_soon_end?page=${idx}" class="page-link">
										${idx }
									</a>
								</li>
							</c:when>
					...
					<c:choose>
						...
						<c:otherwise>
							<li class="page-item">
								<a href="${root }/exhibition/exhibition_soon_end?page=${pageBean.nextPage}" class="page-link">다음</a>
							</li>
						</c:otherwise>
					</c:choose>
				</ul>
