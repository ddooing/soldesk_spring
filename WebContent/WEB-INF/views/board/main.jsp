		...
		<div class="active contentshow" id="totalListContent">
			<div>
                ...
                <select class="ty3" title="검색조건 제목 선택" id="selectCondition1">
                    ...
                    <%-- 서버 측 코드를 사용하여 동적으로 option 값을 생성할 수 있습니다. --%>
                    <%-- 예시: --%>
                    <%-- <c:forEach items="${searchConditions}" var="condition"> --%>
                    <%--     <option value="${condition.value}">${condition.label}</option> --%>
                    <%-- </c:forEach> --%>
                </select>
                <input type="text" placeholder="검색어를 입력해주세요." title="검색어를 입력해주세요" id="searchKeyword1" style="width: 630px;">
					...
					<table class="tbl_list text_c" summary="공지사항에 대한 표입니다">
						...
						<tbody>
							<tr>
								...
								<td class="text_l"><a href="${root}/board/post" id="2578"
							...
							<tr>
								<td><strong class="ico_imp"><span>중요</span></strong></td>
								<td class="text_l"><a href="${root}/board/post" id="2541"
									class="txt_color01">중요 게시글입니다.</a></td>
								<td>관리자</td>
								<td>2023-06-08</td>
							</tr>
							<tr>
								<td>28</td>
								<td class="text_l"><a href="${root }/board/boardpost" id="2606" class="">게시글입니다.</a></td>
								<td>사용자이름</td>
								<td>2023-12-07</td>
							</tr>
							<tr>
								<td>27</td>
								<td class="text_l"><a href="${root }/board/boardpost" id="2605" class="">게시글입니다.</a></td>
								<td>사용자이름</td>
								<td>2023-12-01</td>
							</tr>
							<tr>
								<td>26</td>
								<td class="text_l"><a href="${root }/board/boardpost" id="2602" class="">게시글입니다.</a></td>
								<td>사용자이름</td>
								<td>2023-12-01</td>
							</tr>
							<tr>
								<td>25</td>
								<td class="text_l"><a href="${root }/board/boardpost" id="2596" class="">게시글입니다.</a></td>
								<td>사용자이름</td>
								<td>2023-11-16</td>
							</tr>
							<tr>
								<td>24</td>
								<td class="text_l"><a href="${root }/board/boardpost" id="2594" class="">게시글입니다.</a></td>
								<td>사용자이름</td>
								<td>2023-12-06</td>
							</tr>
							<tr>
								<td>23</td>
								<td class="text_l"><a href="${root }/board/boardpost" id="2591" class="">게시글입니다.</a></td>
								<td>사용자이름</td>
								<td>2023-10-13</td>
							</tr>
							<tr>
								<td>22</td>
								<td class="text_l"><a href="${root }/board/boardpost" id="2590" class="">게시글입니다.</a></td>
								<td>사용자이름</td>
								<td>2023-10-11</td>
							</tr>
							<tr>
								<td>21</td>
								<td class="text_l"><a href="${root }/board/boardpost" id="2587" class="">게시글입니다.</a></td>
								<td>사용자이름</td>
								<td>2023-10-05</td>
							</tr>
						</tbody>
