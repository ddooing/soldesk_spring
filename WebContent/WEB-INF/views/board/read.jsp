      ...
      <div class="board_title"
         ...
         <h3>
            <a href="${root}/board/main"
               style="font-size: 42px; margin-left: 20px; color: black; text-decoration: none;">게시판</a>
         </h3>
      </div>
      <div>
         <div class="active">
            <div class="tab_con">
                  <table class="tbl_dtal" summary="게시판 상세내용에 대한 표입니다">
                  	<thead>
	                     <tr>
	                        <th scope="col" colspan="3" style="padding: 6px; border-top: 1px solid #EEEEEE; border-left: 1px solid #EEEEEE;  border-right: 1px solid #EEEEEE"">${readContentBean.title }   
	                        </th>
	                     </tr>
                     </thead>
                     <tbody>
                        <tr style="text-align: center; background-color: rgb(200, 200, 200); ">
                           <td style= "width: 380px;">
                              <label for="user_id"> 
                                 <span class="tit" style="margin-left: 30px;">작성자 </span>
                              </label>
                              <pre style="display: inline;">  |</pre>
                              <label class="form-control" style="background: #c8c8c8; font-size: 20px; border: none; width: 120px; display: inline;">
                              	 ${readContentBean.nickname}
                              </label>
                           </td>
                           <td style="text-align: right;">
                              ...
                              <pre style="display: inline;">  |  </pre>
                              <label style="background: #c8c8c8; border: none; width: 120px; font-size: 20px; display: inline; margin-right: 20px;">
              					${readContentBean.update_date}
                              </label>
                           </td>
                           <td style="text-align: right;">
                              <label for="views"> 
                              ...
                              <pre style="display: inline;">  |  </pre>
                              <label style="background: #c8c8c8; border: none; width: 120px; font-size: 20px; display: inline; margin-right: 50px;">
                              	${readContentBean.views}
                              </label>
                           </td>
                        </tr>
                        <tr class="tb_content" style="height: 350px; vertical-align:text-top; border-right: 1px solid #EEEEEE; border-left: 1px solid #EEEEEE;">
                           <td colspan="3">
                        ...
                        <tr class="tb_link" style="border-right: 1px solid #EEEEEE; border-left: 1px solid #EEEEEE;">
                           <td colspan="3">
