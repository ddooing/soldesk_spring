				...
				<div class="tab_con">
					<ul class="tab_wrap inner">
						<table class="tbl_dtal" summary="게시판 상세내용에 대한 표입니다">
							...
							<tr>	
								<th scope="col" style=" padding:6px;" > <!-- 제목 -->
							...
							<tbody style = "border:1px solid black;">
								<tr class="tb_info">
									<td style="background-color: rgb(200,200,200); border:1px solid rgb(200,200,200);">
										<label for="user_id"><span class="tit" >작성자</span> </label>
										<input type="text" id="user_id" name="cont unvisible" class="form-control" value="${readContentBean.user_id}" style="width:100px; display: inline; margin-right:20px;" disabled="disabled"/>
										
										<label for = "create_date"><span class="tit">등록일</span></label><!-- ? 아래에 update_date를 넣어야하는 지 의문 -->
										<input type="text" id="create_date" name="create_date" class="form-control" value="${readContentBean.create_date}" style="width:170px;display: inline; margin-right:20px;" disabled="disabled"/> <!-- 생성날짜 -->
										
										<label for = "views"><span class="tit">조회수</span></label>
										<input type="text" id="views" name="views" class="cont" value="${readContentBean.views}" disabled="disabled"/>
									</td>
								</tr>
								<tr class="tb_content" style="height: 350px;">
									<td>
										<div id="divNoticeContents"><!-- 내용 -->
											<textarea id="contents" name="contents" style="resize:none; border: hidden; " disabled="disabled">${readContentBean.contents }</textarea>
										</div>
									</td>
								</tr>
								<tr class="tb_link">
