								...
								<tr style="height: 80px;">
									...
									<td style="width: 400px;">
									    <div style="display: flex;">
									        <form:input type="date" id="exhibition_start" path="exhibition_start"
									                    style="border:none; border-bottom: 1px solid black; width:200px; text-align: center; font-size: 20px; margin-right:35px;"
									                    onchange="validateDate()" required="required" />
									        ~
									        <form:input type="date" id="exhibition_end" path="exhibition_end"
