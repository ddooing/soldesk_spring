							...
							<tbody>
								<c:forEach items="${boardList}" var="boardList">
									<tr style="vertical-align: middle;">
										...
										<td><a href="${root}/admin/manager_boardlook?board_id=${boardList.board_id}" style="text-align:left; text-decoration-line:none;color:black;">${boardList.title}</a></td>
										...
										<td>
											<c:choose>
											    <c:when test="${boardList.state == 1 }">
											        <a href="#" class="btn btn-danger delete-link" data-href="${root }/admin/onedelete?board_id=${boardList.board_id}">삭제</a>
											    </c:when>
											    <c:when test="${boardList.state == 2 }">
											        <a href="#" class="btn btn-danger delete-link" data-href="${root }/admin/onedelete?board_id=${boardList.board_id}">삭제</a>
											    </c:when>
