					...
					<div
						...
						<table class="table table-bordered">
							...
							<tr style="align-items: center; height: 100px;">
								...
								<td style="vertical-align: middle; font-size:20px;" colspan="3">
									관리자
								</td>
							</tr>
							<tr style="align-items: center; height: 100px;">
							...
							<div style="float:right; margin-bottom:50px;">
								<button class="btn btn-danger" style="margin-right: 15px;" onclick="location.href='manager_boardlist.jsp'" type="submit">취소</button>
