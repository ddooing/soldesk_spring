	...
	<c:import url="/WEB-INF/views/include/admin_header.jsp" />
		...
		<div id="layoutSidenav_content">
			<main style="background-color: ivory;">
				...
				<h3 onclick="window.location='${root}/admin/manager_subbannershowlist'" style="cursor: pointer;">노출중</h3>
				<h3 onclick="window.location='${root}/admin/manager_subbannerhidelist'" style=" margin-left:30px; color:#e2e2e2; cursor: pointer;">숨김</h3>
				</div>
