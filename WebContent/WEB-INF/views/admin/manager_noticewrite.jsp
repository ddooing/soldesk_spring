			...
			<main style="background-color: ivory;">
				<div class="container-fluid px-4">
					...
					<div style="position: relative; margin:20px; display: flex; justify-content: start; height: 80px; align-items: center; background-color: #E8E8E8; margin-top: 20px;">
						<button class="btn btn-dark" style="margin-left: 50px;">공지사항 관리</button>
						<button class="btn btn-dark" style="margin-left: 20px;" onclick="location.href='manager_noticemanage.jsp'">공지사항 목록</button>
					</div>
					...
					<div
						...
						<table class="table table-bordered">
							...
							<tr style="align-items: center; height: 100px;">
								<th style="vertical-align: middle; font-size:20px;">옵션*</th>
								<td style="vertical-align: middle;" colspan="3">
									<input type="radio" id="all" name="boardname" value="all" style="width: 20px; height: 20px; margin-left:50px;"> 
									<label for="all" style="margin-right: 50px; font-size: 20px; margin-left:20px;">전체</label> 
									<input type="radio" id="exhibition" name="boardname" value="exhibition" style="width: 20px; height: 20px; margin-left:30px;"> 
									<label for="exhibition" style="font-size: 20px; margin-left:20px;">전시회</label>
								</td>
							</tr>
							<tr style="align-items: center; height: 100px;">
								<th style="vertical-align: middle; width:200px; font-size:20px;">중요 여부*</th>
								<td style="vertical-align: middle; width:500px;">
									<input type="radio" id="important" name="important" value="important" style="width: 20px; height: 20px; margin-left:50px;"> 
									<label for="important" style="margin-right: 50px; font-size: 20px; margin-left:20px;">표기</label> 
									<input type="radio" id="notimportant" name="important" value="notimportant" style="width: 20px; height: 20px; margin-left:30px;"> 
									<label for="notimportant" style="font-size: 20px; margin-left:20px;">미표기</label>
								</td>
								<th style="vertical-align: middle; width:200px; font-size:20px;">
									공개 여부*
								</th>
								<td style="vertical-align: middle;  width:500px;">
									<input type="radio" id="open" name="open" value="open" style="width: 20px; height: 20px; margin-left:50px;"> 
									<label for="open" style="margin-right: 50px; font-size: 20px; margin-left:20px;">공개</label> 
									<input type="radio" id="noopen" name="open" value="noopen" style="width: 20px; height: 20px; margin-left:30px;"> 
